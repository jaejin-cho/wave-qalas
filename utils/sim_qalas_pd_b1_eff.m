function [Mz_mtx, Mxy_mtx] = sim_qalas_pd_b1_eff(TR, alpha_deg, esp, turbo_factor, t1_vals, t2_vals, num_reps, echo2use, gap_between_readouts, time2relax_at_the_end, b1, inv_eff, pd_map )
%
